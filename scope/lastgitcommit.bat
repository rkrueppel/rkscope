...
FOR /F %%w IN ('"C:\Progra~2\Micros~4\2017\Community\Common7\IDE\CommonExtensions\Microsoft\TeamFoundation\Teamex~1\Git\cmd\git.exe log --format=%%h -1"') DO SET dummy2=%%w
