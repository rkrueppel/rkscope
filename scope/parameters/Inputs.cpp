...
Inputs::Inputs()
	: channels(2, 1, SCOPE_MAXCHANNELS, L"Channels")
...
std::unique_ptr<Inputs> Inputs::Factory(const InputsType& _type) {
	switch ( _type.t ) {
	case InputsTypeHelper::InputsDAQmx:
		return InputsDAQmx::Create();
	case InputsTypeHelper::InputsFPGA:
		return InputsFPGA::Create();
	case InputsTypeHelper::InputsFPGAIO6587:
		return InputsFPGAIO6587::Create();
	case InputsTypeHelper::InputsFPGADigitalDemultiplexer:
		return InputsFPGADigitalDemultiplexer::Create();
	case InputsTypeHelper::InputsFPGAPhotonCounter:
	...
	case InputsTypeHelper::InputsFPGAAnalogDemultiplexer:
		return InputsFPGAAnalogDemultiplexer::Create();
	case InputsTypeHelper::InputsFPGAAnalogIntegrator:
		return InputsFPGAAnalogIntegrator::Create();
	case InputsTypeHelper::InputsFPGAResonanceScanner:
