...
Daq::Daq(const bool& _isslave)
	: isslave(_isslave)
	, inputs(Inputs::Factory(InputsTypeHelper::SCOPE_INPUTS_PARAMETERS_T))
	, outputs((_isslave)?Outputs::Factory(OutputsTypeHelper::SCOPE_SLAVEOUTPUTS_T):Outputs::Factory(OutputsTypeHelper::SCOPE_OUTPUTS_T))
