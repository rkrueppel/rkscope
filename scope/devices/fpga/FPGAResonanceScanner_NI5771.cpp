...
FPGAResonanceScannerNI5771::FPGAResonanceScannerNI5771()
	...
	, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_PLLLocked
	, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_Configured
	, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_UserError
	, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorU8_UserCommandStatus
	, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU8_UserCommand
	, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU16_UserData0
	, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU8_UserData1
	, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_UserCommandCommit) {
...
double FPGAResonanceScannerNI5771::SetPixeltime(const uint32_t& _area, const double& _pixeltime) {
	...
	status = NiFpga_WriteU16(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU32_Samplesperpixel, samplesperpixel);
...
double FPGAResonanceScannerNI5771::SetLinetime(const uint32_t& _area, const double& _linetime) {
	...
	status = NiFpga_WriteU16(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU32_Samplesperline, samplesperline);
...
void FPGAResonanceScannerNI5771::SetTriggering(const bool& _waitfortrigger) {
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_Waitfortrigger, _waitfortrigger);
}

void FPGAResonanceScannerNI5771::SetContinuousAcquisition(const bool& _cont) {
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_Acquirecontinuously, _cont);
}

void FPGAResonanceScannerNI5771::SetRequestedPixels(const uint32_t& _area, const uint32_t& _reqpixels) {
	status = NiFpga_WriteU32(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU32_Requestedpixels, _reqpixels);
} 

void FPGAResonanceScannerNI5771::StartAcquisition() {
	ClearFIFOs();
	SetChannelProps();
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_Acquire, true);
}
...
void FPGAResonanceScannerNI5771::StopAcquisition() {
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_Acquire, false);
}
...
void FPGAResonanceScannerNI5771::SetChannelProps() {
	...
	status = NiFpga_WriteU8(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU8_Baselinex8Ch1, parameters->BaselineCh1());
	status = NiFpga_WriteU8(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlU8_Baselinex8Ch2, parameters->BaselineCh2());
...
void FPGAResonanceScannerNI5771::CheckFPGADiagnosis() {
	NiFpga_Bool b;
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_ToHostCh1FIFOOverflow, &b);
	parameters->diagnosis.ToHostOverflowCh1 = (b!=0);
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_ToHostCh2FIFOOverflow, &b);
	parameters->diagnosis.ToHostOverflowCh2 = (b!=0);
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_InterloopFIFOOverflow, &b);
	parameters->diagnosis.InterloopOverflow = (b!=0);
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_InterloopFIFOTimeout, &b);
	parameters->diagnosis.InterloopTimeout = (b!=0);
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_Acquiring, &b);
	parameters->diagnosis.Acquiring = (b!=0);
	status = NiFpga_ReadBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_IndicatorBool_IOModuleAIOverRange, &b);
	parameters->diagnosis.AIOverRange = (b!=0);
}

void FPGAResonanceScannerNI5771::ClearFIFOs() {
	// Clear interloop fifo
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_ClearInterloopFIFO, true);
	std::this_thread::sleep_for(std::chrono::milliseconds(50));
	status = NiFpga_WriteBool(session, NiFpga_AnalogIntegrator_NI5771_Resonance_ControlBool_ClearInterloopFIFO, false);
