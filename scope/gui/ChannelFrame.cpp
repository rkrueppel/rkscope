...
bool CChannelFrame::RunLayOverAndRender(StopCondition* const sc, scope::SCOPE_MULTIIMAGECPTR_T const _multi) {
...
bool CChannelFrame::RunUpdateStatusbar(StopCondition* const sc, scope::SCOPE_MULTIIMAGECPTR_T _multi) {
...
void CChannelFrame::LayOverAndRender(scope::SCOPE_MULTIIMAGECPTR_T const _multi) {
