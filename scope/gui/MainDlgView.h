...
namespace scope {
	namespace gui {
		...
		public:
			...
			CMainDlgView(scope::RunButtons& _runbuttons, scope::parameters::Scope& _guiparameters, std::vector<ScanModeButtons>& _scanmodebuttonsvec, StackButtons& _stackbuttons, ScopeCounters& _counters);
			~CMainDlgView();
