...
namespace scope {
	namespace gui {
		...
		public:
			...
			CBehaviorSettingsPage(RunButtons& _runbuttons, ScopeCounters<SCOPE_NAREAS>& _scopecounters, parameters::Behavior& _behaviorparameters, std::vector<parameters::Area>& _areaparamsvec);
